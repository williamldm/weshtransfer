...
import { SUPABASE_URL, SUPABASE_PUBLISHABLE_KEY } from "./config.js?v=17";
...
import { esc, formatBytes, formatDuration, formatDate, plural, toast, triggerDownload, avatar, fileBadge, fileTile } from "./ui.js?v=17";
