...
import { currentWallpaper, applyWallpaper, startRotation } from "./wallpapers.js?v=69";
...
if (scene) import("./scene-fx.js?v=69").then((m) => m.startSceneFx(scene, rotation)).catch(() => {});
