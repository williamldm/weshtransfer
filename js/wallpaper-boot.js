...
import { currentWallpaper, applyWallpaper, startRotation } from "./wallpapers.js?v=77";
...
if (scene) import("./scene-fx.js?v=77").then((m) => m.startSceneFx(scene, rotation)).catch(() => {});
