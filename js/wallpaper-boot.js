...
import { currentWallpaper, applyWallpaper, startRotation } from "./wallpapers.js?v=72";
...
if (scene) import("./scene-fx.js?v=72").then((m) => m.startSceneFx(scene, rotation)).catch(() => {});
