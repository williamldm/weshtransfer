...
import { currentWallpaper, applyWallpaper, startRotation } from "./wallpapers.js?v=76";
...
if (scene) import("./scene-fx.js?v=76").then((m) => m.startSceneFx(scene, rotation)).catch(() => {});
