...
import { currentWallpaper, applyWallpaper, startRotation } from "./wallpapers.js?v=90";
...
if (scene) import("./scene-fx.js?v=90").then((m) => m.startSceneFx(scene, rotation)).catch(() => {});
