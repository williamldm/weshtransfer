...
import { currentWallpaper, applyWallpaper, startRotation } from "./wallpapers.js?v=67";
...
if (scene) import("./scene-fx.js?v=67").then((m) => m.startSceneFx(scene, rotation)).catch(() => {});
