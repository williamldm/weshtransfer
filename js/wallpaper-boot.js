...
import { currentWallpaper, applyWallpaper, startRotation } from "./wallpapers.js?v=86";
...
if (scene) import("./scene-fx.js?v=86").then((m) => m.startSceneFx(scene, rotation)).catch(() => {});
