...
import { currentWallpaper, applyWallpaper, startRotation } from "./wallpapers.js?v=70";
...
if (scene) import("./scene-fx.js?v=70").then((m) => m.startSceneFx(scene, rotation)).catch(() => {});
