...
import { currentWallpaper, applyWallpaper, startRotation } from "./wallpapers.js?v=95";
...
if (scene) import("./scene-fx.js?v=95").then((m) => m.startSceneFx(scene, rotation)).catch(() => {});
