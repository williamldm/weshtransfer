...
import { currentWallpaper, applyWallpaper, startRotation } from "./wallpapers.js?v=74";
...
if (scene) import("./scene-fx.js?v=74").then((m) => m.startSceneFx(scene, rotation)).catch(() => {});
