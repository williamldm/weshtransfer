...
import { currentWallpaper, applyWallpaper, startRotation } from "./wallpapers.js?v=89";
...
if (scene) import("./scene-fx.js?v=89").then((m) => m.startSceneFx(scene, rotation)).catch(() => {});
