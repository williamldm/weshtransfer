...
import { currentWallpaper, applyWallpaper, startRotation } from "./wallpapers.js?v=94";
...
if (scene) import("./scene-fx.js?v=94").then((m) => m.startSceneFx(scene, rotation)).catch(() => {});
