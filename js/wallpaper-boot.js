...
import { currentWallpaper, applyWallpaper, startRotation } from "./wallpapers.js?v=87";
...
if (scene) import("./scene-fx.js?v=87").then((m) => m.startSceneFx(scene, rotation)).catch(() => {});
