...
import { currentWallpaper, applyWallpaper, startRotation } from "./wallpapers.js?v=75";
...
if (scene) import("./scene-fx.js?v=75").then((m) => m.startSceneFx(scene, rotation)).catch(() => {});
