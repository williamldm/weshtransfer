...
import { currentWallpaper, applyWallpaper, startRotation } from "./wallpapers.js?v=96";
...
if (scene) import("./scene-fx.js?v=96").then((m) => m.startSceneFx(scene, rotation)).catch(() => {});
