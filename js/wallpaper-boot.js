...
import { currentWallpaper, applyWallpaper, startRotation } from "./wallpapers.js?v=85";
...
if (scene) import("./scene-fx.js?v=85").then((m) => m.startSceneFx(scene, rotation)).catch(() => {});
