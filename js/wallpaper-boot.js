...
import { currentWallpaper, applyWallpaper, startRotation } from "./wallpapers.js?v=82";
...
if (scene) import("./scene-fx.js?v=82").then((m) => m.startSceneFx(scene, rotation)).catch(() => {});
