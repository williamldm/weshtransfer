...
import { currentWallpaper, applyWallpaper, startRotation } from "./wallpapers.js?v=88";
...
if (scene) import("./scene-fx.js?v=88").then((m) => m.startSceneFx(scene, rotation)).catch(() => {});
