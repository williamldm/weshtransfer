...
import { currentWallpaper, applyWallpaper, startRotation } from "./wallpapers.js?v=91";
...
if (scene) import("./scene-fx.js?v=91").then((m) => m.startSceneFx(scene, rotation)).catch(() => {});
