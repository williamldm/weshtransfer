...
import { currentWallpaper, applyWallpaper, startRotation } from "./wallpapers.js?v=92";
...
if (scene) import("./scene-fx.js?v=92").then((m) => m.startSceneFx(scene, rotation)).catch(() => {});
