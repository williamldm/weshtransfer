...
import { currentWallpaper, applyWallpaper, startRotation } from "./wallpapers.js?v=93";
...
if (scene) import("./scene-fx.js?v=93").then((m) => m.startSceneFx(scene, rotation)).catch(() => {});
