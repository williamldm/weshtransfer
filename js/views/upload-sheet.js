...
import { enqueue, checkFile, guessKind, guessBpm, titleFromName } from "../upload.js?v=21";
import { listProjects, createProject } from "../api.js?v=21";
import { icon } from "../icons.js?v=21";
import { CATEGORY, categoryOf, isAudio } from "../files.js?v=21";
import { esc, h, openSheet, toast, errorText, formatBytes, KINDS } from "../ui.js?v=21";
