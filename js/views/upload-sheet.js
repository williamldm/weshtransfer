...
import { enqueue, checkFile, guessKind, guessBpm, titleFromName } from "../upload.js?v=2";
import { listProjects, createProject } from "../api.js?v=2";
import { icon } from "../icons.js?v=2";
import { esc, h, openSheet, toast, errorText, formatBytes, KINDS } from "../ui.js?v=2";
