...
import { listParticipants, updateSpace } from "../api.js?v=2";
import { icon } from "../icons.js?v=2";
import { esc, h, openSheet, avatar, shareLink, copyText, toast, errorText, formatDate, confirmSheet, canShare } from "../ui.js?v=2";
import { leaveSpace } from "../session.js?v=2";
