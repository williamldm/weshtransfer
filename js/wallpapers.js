...
export const WALLPAPERS = [
  { file: "img/scenes/plateforme.svg?v=87", title: "Plateforme pétrolière, torchère allumée", joke: "Chaque envoi rallume la torchère." },
  { file: "img/scenes/serveurs.svg?v=87", title: "Ferme de serveurs dans le désert", joke: "Refroidie à l'eau potable, évidemment." },
  { file: "img/scene.svg?v=87", title: "Centrale thermique, la nuit", joke: "Ce fond d'écran consomme plus que ton frigo." },
  { file: "img/scenes/aeroport.svg?v=87", title: "Aéroport, jets privés", joke: "Un jet par fichier. Deux pour les WAV." },
  { file: "img/scenes/ski.svg?v=87", title: "Station de ski, en août", joke: "Neige artificielle, 24 degrés dehors." },
  { file: "img/scenes/autoroute.svg?v=87", title: "Périphérique, 23 h", joke: "Tous en SUV, clim à fond, seul à bord." }
];
