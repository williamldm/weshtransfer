...
import { restore, getSpace, leaveSpace } from "./session.js?v=92";
import { connectSpace } from "./realtime.js?v=92";
import { startJam } from "./jam.js?v=92";
import { bindPlayerBar } from "./player.js?v=92";
import { activeCount, onUploads } from "./upload.js?v=92";
import { openPeopleSheet } from "./views/people.js?v=92";
import { openUploadSheet } from "./views/upload-sheet.js?v=92";
import { icon } from "./icons.js?v=92";
import { monogram } from "./brand.js?v=92";
import { toast, errorText, esc } from "./ui.js?v=92";

import * as home from "./views/home.js?v=92";
import * as project from "./views/project.js?v=92";
import * as file from "./views/file.js?v=92";
import * as send from "./views/send.js?v=92";
import * as transfers from "./views/transfers.js?v=92";
...
async function boot() {
  ...
  import("./session.js?v=92").then((m) => m.syncSpaces()).catch(() => {});
