...
import { restore, getSpace, leaveSpace } from "./session.js?v=72";
import { connectSpace } from "./realtime.js?v=72";
import { startJam } from "./jam.js?v=72";
import { bindPlayerBar } from "./player.js?v=72";
import { activeCount, onUploads } from "./upload.js?v=72";
import { openPeopleSheet } from "./views/people.js?v=72";
import { openUploadSheet } from "./views/upload-sheet.js?v=72";
import { icon } from "./icons.js?v=72";
import { monogram } from "./brand.js?v=72";
import { toast, errorText, esc } from "./ui.js?v=72";

import * as home from "./views/home.js?v=72";
import * as project from "./views/project.js?v=72";
import * as file from "./views/file.js?v=72";
import * as send from "./views/send.js?v=72";
import * as transfers from "./views/transfers.js?v=72";
...
async function boot() {
  ...
  import("./session.js?v=72").then((m) => m.syncSpaces()).catch(() => {});
