...
import { restore, getSpace, leaveSpace } from "./session.js?v=86";
import { connectSpace } from "./realtime.js?v=86";
import { startJam } from "./jam.js?v=86";
import { bindPlayerBar } from "./player.js?v=86";
import { activeCount, onUploads } from "./upload.js?v=86";
import { openPeopleSheet } from "./views/people.js?v=86";
import { openUploadSheet } from "./views/upload-sheet.js?v=86";
import { icon } from "./icons.js?v=86";
import { monogram } from "./brand.js?v=86";
import { toast, errorText, esc } from "./ui.js?v=86";

import * as home from "./views/home.js?v=86";
import * as project from "./views/project.js?v=86";
import * as file from "./views/file.js?v=86";
import * as send from "./views/send.js?v=86";
import * as transfers from "./views/transfers.js?v=86";
...
async function boot() {
  ...
  import("./session.js?v=86").then((m) => m.syncSpaces()).catch(() => {});
