...
import { restore, getSpace, leaveSpace } from "./session.js?v=87";
import { connectSpace } from "./realtime.js?v=87";
import { startJam } from "./jam.js?v=87";
import { bindPlayerBar } from "./player.js?v=87";
import { activeCount, onUploads } from "./upload.js?v=87";
import { openPeopleSheet } from "./views/people.js?v=87";
import { openUploadSheet } from "./views/upload-sheet.js?v=87";
import { icon } from "./icons.js?v=87";
import { monogram } from "./brand.js?v=87";
import { toast, errorText, esc } from "./ui.js?v=87";

import * as home from "./views/home.js?v=87";
import * as project from "./views/project.js?v=87";
import * as file from "./views/file.js?v=87";
import * as send from "./views/send.js?v=87";
import * as transfers from "./views/transfers.js?v=87";
...
async function boot() {
  ...
  import("./session.js?v=87").then((m) => m.syncSpaces()).catch(() => {});
