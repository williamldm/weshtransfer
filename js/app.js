...
import { restore, getSpace, leaveSpace } from "./session.js?v=47";
import { connectSpace } from "./realtime.js?v=47";
import { bindPlayerBar } from "./player.js?v=47";
import { activeCount, onUploads } from "./upload.js?v=47";
import { openPeopleSheet } from "./views/people.js?v=47";
import { openUploadSheet } from "./views/upload-sheet.js?v=47";
import { icon } from "./icons.js?v=47";
import { monogram } from "./brand.js?v=47";
import { toast, errorText, esc } from "./ui.js?v=47";

import * as home from "./views/home.js?v=47";
import * as project from "./views/project.js?v=47";
import * as file from "./views/file.js?v=47";
import * as send from "./views/send.js?v=47";
import * as transfers from "./views/transfers.js?v=47";
...
async function boot() {
  ...
  import("./session.js?v=47").then((m) => m.syncSpaces()).catch(() => {});
