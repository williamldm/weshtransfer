...
import { restore, getSpace, leaveSpace } from "./session.js?v=67";
import { connectSpace } from "./realtime.js?v=67";
import { startJam } from "./jam.js?v=67";
import { bindPlayerBar } from "./player.js?v=67";
import { activeCount, onUploads } from "./upload.js?v=67";
import { openPeopleSheet } from "./views/people.js?v=67";
import { openUploadSheet } from "./views/upload-sheet.js?v=67";
import { icon } from "./icons.js?v=67";
import { monogram } from "./brand.js?v=67";
import { toast, errorText, esc } from "./ui.js?v=67";

import * as home from "./views/home.js?v=67";
import * as project from "./views/project.js?v=67";
import * as file from "./views/file.js?v=67";
import * as send from "./views/send.js?v=67";
import * as transfers from "./views/transfers.js?v=67";
...
async function boot() {
  ...
  import("./session.js?v=67").then((m) => m.syncSpaces()).catch(() => {});
