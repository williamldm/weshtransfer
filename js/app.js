...
import { restore, getSpace, leaveSpace } from "./session.js?v=95";
import { connectSpace } from "./realtime.js?v=95";
import { startJam } from "./jam.js?v=95";
import { bindPlayerBar } from "./player.js?v=95";
import { activeCount, onUploads } from "./upload.js?v=95";
import { openPeopleSheet } from "./views/people.js?v=95";
import { openUploadSheet } from "./views/upload-sheet.js?v=95";
import { icon } from "./icons.js?v=95";
import { monogram } from "./brand.js?v=95";
import { toast, errorText, esc } from "./ui.js?v=95";

import * as home from "./views/home.js?v=95";
import * as project from "./views/project.js?v=95";
import * as file from "./views/file.js?v=95";
import * as send from "./views/send.js?v=95";
import * as transfers from "./views/transfers.js?v=95";
...
async function boot() {
  ...
  import("./session.js?v=95").then((m) => m.syncSpaces()).catch(() => {});
