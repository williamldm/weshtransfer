...
import { restore, getSpace, leaveSpace } from "./session.js?v=41";
import { connectSpace } from "./realtime.js?v=41";
import { bindPlayerBar } from "./player.js?v=41";
import { activeCount, onUploads } from "./upload.js?v=41";
import { openPeopleSheet } from "./views/people.js?v=41";
import { openUploadSheet } from "./views/upload-sheet.js?v=41";
import { icon } from "./icons.js?v=41";
import { monogram } from "./brand.js?v=41";
import { toast, errorText, esc } from "./ui.js?v=41";

import * as home from "./views/home.js?v=41";
import * as project from "./views/project.js?v=41";
import * as file from "./views/file.js?v=41";
import * as send from "./views/send.js?v=41";
import * as transfers from "./views/transfers.js?v=41";
...
async function boot() {
  ...
  import("./session.js?v=41").then((m) => m.syncSpaces()).catch(() => {});
