...
import { restore, getSpace, leaveSpace } from "./session.js?v=63";
import { connectSpace } from "./realtime.js?v=63";
import { startJam } from "./jam.js?v=63";
import { bindPlayerBar } from "./player.js?v=63";
import { activeCount, onUploads } from "./upload.js?v=63";
import { openPeopleSheet } from "./views/people.js?v=63";
import { openUploadSheet } from "./views/upload-sheet.js?v=63";
import { icon } from "./icons.js?v=63";
import { monogram } from "./brand.js?v=63";
import { toast, errorText, esc } from "./ui.js?v=63";

import * as home from "./views/home.js?v=63";
import * as project from "./views/project.js?v=63";
import * as file from "./views/file.js?v=63";
import * as send from "./views/send.js?v=63";
import * as transfers from "./views/transfers.js?v=63";
...
async function boot() {
  ...
  import("./session.js?v=63").then((m) => m.syncSpaces()).catch(() => {});
