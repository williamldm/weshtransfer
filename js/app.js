...
import { restore, getSpace, leaveSpace } from "./session.js?v=74";
import { connectSpace } from "./realtime.js?v=74";
import { startJam } from "./jam.js?v=74";
import { bindPlayerBar } from "./player.js?v=74";
import { activeCount, onUploads } from "./upload.js?v=74";
import { openPeopleSheet } from "./views/people.js?v=74";
import { openUploadSheet } from "./views/upload-sheet.js?v=74";
import { icon } from "./icons.js?v=74";
import { monogram } from "./brand.js?v=74";
import { toast, errorText, esc } from "./ui.js?v=74";

import * as home from "./views/home.js?v=74";
import * as project from "./views/project.js?v=74";
import * as file from "./views/file.js?v=74";
import * as send from "./views/send.js?v=74";
import * as transfers from "./views/transfers.js?v=74";
...
async function boot() {
  ...
  import("./session.js?v=74").then((m) => m.syncSpaces()).catch(() => {});
