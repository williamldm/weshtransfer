...
import { restore, getSpace, leaveSpace } from "./session.js?v=35";
import { connectSpace } from "./realtime.js?v=35";
import { bindPlayerBar } from "./player.js?v=35";
import { activeCount, onUploads } from "./upload.js?v=35";
import { openPeopleSheet } from "./views/people.js?v=35";
import { openUploadSheet } from "./views/upload-sheet.js?v=35";
import { icon } from "./icons.js?v=35";
import { monogram } from "./brand.js?v=35";
import { toast, errorText, esc } from "./ui.js?v=35";

import * as home from "./views/home.js?v=35";
import * as project from "./views/project.js?v=35";
import * as file from "./views/file.js?v=35";
import * as send from "./views/send.js?v=35";
import * as transfers from "./views/transfers.js?v=35";
