...
import { restore, getSpace, leaveSpace } from "./session.js?v=96";
import { connectSpace } from "./realtime.js?v=96";
import { startJam } from "./jam.js?v=96";
import { bindPlayerBar } from "./player.js?v=96";
import { activeCount, onUploads } from "./upload.js?v=96";
import { openPeopleSheet } from "./views/people.js?v=96";
import { openUploadSheet } from "./views/upload-sheet.js?v=96";
import { icon } from "./icons.js?v=96";
import { monogram } from "./brand.js?v=96";
import { toast, errorText, esc } from "./ui.js?v=96";

import * as home from "./views/home.js?v=96";
import * as project from "./views/project.js?v=96";
import * as file from "./views/file.js?v=96";
import * as send from "./views/send.js?v=96";
import * as transfers from "./views/transfers.js?v=96";
...
async function boot() {
  ...
  import("./session.js?v=96").then((m) => m.syncSpaces()).catch(() => {});
