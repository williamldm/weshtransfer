...
import { restore, getSpace, leaveSpace } from "./session.js?v=53";
import { connectSpace } from "./realtime.js?v=53";
import { startJam } from "./jam.js?v=53";
import { bindPlayerBar } from "./player.js?v=53";
import { activeCount, onUploads } from "./upload.js?v=53";
import { openPeopleSheet } from "./views/people.js?v=53";
import { openUploadSheet } from "./views/upload-sheet.js?v=53";
import { icon } from "./icons.js?v=53";
import { monogram } from "./brand.js?v=53";
import { toast, errorText, esc } from "./ui.js?v=53";

import * as home from "./views/home.js?v=53";
import * as project from "./views/project.js?v=53";
import * as file from "./views/file.js?v=53";
import * as send from "./views/send.js?v=53";
import * as transfers from "./views/transfers.js?v=53";
...
async function boot() {
  ...
  import("./session.js?v=53").then((m) => m.syncSpaces()).catch(() => {});
