...
import { sb, BUCKET } from "./db.js?v=88";
import { SUPABASE_URL, SUPABASE_PUBLISHABLE_KEY, PEAKS_MAX_BYTES } from "./config.js?v=88";
import { extOf as fileExt, isBlocked, isAudio, mimeOf, FILE_MAX } from "./files.js?v=88";
import { computePeaks } from "./peaks.js?v=88";
import { insertFile, storageCall, storageConfig } from "./api.js?v=88";
import { errorText } from "./ui.js?v=88";
...
function explain(err) {
  ...
  if (/QUOTA_|STOCKAGE_PLEIN|TROP_D_UPLOADS|TAILLE_INCOHERENTE|UPLOAD_INCONNU|ESPACE_PLEIN|TROP_RAPIDE/.test(code)) return errorText(err);
